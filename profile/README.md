...
- [VirtualRobotics-Unity](https://github.com/VirtualRobotics/VirtualRobotics-Unity): The visualization and RL engine. 
- [VirtualRobotics-Server](https://github.com/VirtualRobotics/VirtualRobotics-Server): The backend logic (Computer Vision/ML).
...
- Unity version 6.0 [Download here](https://unity.com/releases/editor/archive) or via [Unity Hub]()
- uv tool [(installation link)](https://docs.astral.sh/uv/getting-started/installation/)
- Python 3.11+ (will be automatically downloaded with uv after running the project)
---
